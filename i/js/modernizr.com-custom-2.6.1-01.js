...
Modernizr.load([
  ...
  //   yep: '//use.typekit.net/uqi6bct.js',
  //   callback: function () {
  //     try { Typekit.load(); }
  //     catch(e){}
  //   },
  //   complete: function () {
  //     document.documentElement.className = document.documentElement.className.replace(/\stk-loading\s/, '');
  //   }
  // }, {
